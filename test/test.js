...
describe("NFTMarket", function() {
  it("Should interact with the token contract", async function() {
    ...
    await market.createMarketItem(nftContractAddress, 1, 1000, {value: listingPrice});
    await market.createMarketItem(nftContractAddress, 2, 1000, {value: listingPrice})
    await market.createMarketItem(nftContractAddress, 3, 1000, {value: listingPrice})
    ...
    await market.createMarketItem(nftContractAddress, 4, 1000, {value: listingPrice})
    await market.createMarketItem(nftContractAddress, 5, 1000, {value: listingPrice})
    await market.createMarketItem(nftContractAddress, 6, 1000, {value: listingPrice})
    await market.createMarketItem(nftContractAddress, 7, 1000, {value: listingPrice})
    await market.createMarketItem(nftContractAddress, 8, 1000, {value: listingPrice})
    await market.createMarketItem(nftContractAddress, 9, 1000, {value: listingPrice})
